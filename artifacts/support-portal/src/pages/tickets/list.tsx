              ...
              {isLoading ? (
                [1, 2, 3, 4, 5].map((i) => (
                  <TableRow key={i} className="animate-pulse">
                    ...
                    <TableCell><div className="h-4 bg-stone-200 rounded w-48 mb-2"></div><div className="h-3 bg-stone-100 rounded w-24"></div></TableCell>
                    ...
                    <TableCell><div className="h-4 bg-stone-200 rounded w-16"></div></TableCell>
                ...
                <TableRow>
                  <TableCell colSpan={7} className="h-64 text-center">
                    <div className="flex flex-col items-center justify-center text-stone-500">
                      <Search className="h-8 w-8 mb-4 text-stone-300" />
                ...
                tickets?.map((ticket) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="text-sm text-stone-600">{lookupLabel(ticketConfig?.environments, ticket.environment)}</span>
                    </TableCell>
                    <TableCell>
