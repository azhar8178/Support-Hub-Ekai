...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans text-[#0F1F3D]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-20 text-center">
        <div className="mb-6 inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-sm text-blue-700">
          <span className="flex h-2 w-2 rounded-full bg-blue-600 mr-2"></span>
          Enterprise Support Portal
        </div>
        <h1 className="max-w-3xl text-5xl font-bold tracking-tight text-[#0F1F3D] sm:text-6xl mb-6">
          Precise, trustworthy <span className="text-[#2563EB]">support</span> for your data platforms.
        </h1>
        ...
        <div className="flex items-center gap-4">
          <Link href="/sign-in" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors h-11 px-8 bg-[#2563EB] text-white hover:bg-[#1d4ed8] shadow-sm">
            Sign in to Portal
          </Link>
        </div>
        ...
        <div className="mt-20 max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <p className="text-slate-600 text-sm">Clear SLA tracking and immediate routing to specialized data engineers for P1/P2 incidents.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <p className="text-slate-600 text-sm">Full context tracking across AWS, Azure, GCP, and Snowflake environments.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <p className="text-slate-600 text-sm">Access curated deployment guides, troubleshooting playbooks, and release notes.</p>
          </div>
        </div>
      </main>
