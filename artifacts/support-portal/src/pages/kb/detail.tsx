  ...
  if (error || !article) {
    return (
      <div className="p-8 max-w-4xl mx-auto text-center">
        ...
        <p className="text-slate-500 mt-2">The article you're looking for doesn't exist or is unpublished.</p>
  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
      ...
      <div className="border-b border-slate-200 bg-slate-50 px-6 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <Button variant="ghost" asChild className="-ml-4 text-slate-500 hover:text-[#0F1F3D]">
              <Link href="/kb">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            {!article.published && (
              <span className="text-xs font-bold uppercase tracking-wider text-slate-600 bg-slate-100 px-2.5 py-1 rounded-md border border-slate-200">
                Draft
              </span>
            )}
          </div>
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        <div className="prose prose-slate prose-blue max-w-none prose-headings:text-[#0F1F3D] prose-a:text-[#2563EB]">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200">
          <div className="bg-slate-50 rounded-xl p-8 text-center border border-slate-200">
            ...
            <p className="text-sm text-slate-500 mb-6">Let us know so we can improve our documentation.</p>
            ...
            {feedbackSubmitted && (
              <p className="text-sm text-slate-500 mt-4">Thank you for your feedback.</p>
            )}
          </div>
        </div>
      </div>
